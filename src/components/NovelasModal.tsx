...
export function NovelasModal({ isOpen, onClose }: NovelasModalProps) {
  ...
  useEffect(() => {
    const handleAdminNovelsUpdate = (event: CustomEvent) => {
      const updatedNovels = event.detail;
      const novelasWithDefaultPayment = updatedNovels.map((novel: any) => ({
        id: novel.id,
        titulo: novel.titulo,
        genero: novel.genero,
        capitulos: novel.capitulos,
    ...
    window.addEventListener('admin_novels_updated', handleAdminNovelsUpdate as EventListener);
    return () => {
      window.removeEventListener('admin_novels_updated', handleAdminNovelsUpdate as EventListener);
    };
  }, []);
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base opacity-90">
                  {allNovelas.length > 0 ? `${allNovelas.length} novelas disponibles` : 'Catálogo actualizado en tiempo real'}
                </p>
              </div>
            </div>
            <button
            ...
            {allNovelas.length === 0 && (
              <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 text-center">
                ...
                <p className="text-yellow-700">
                  El catálogo de novelas está vacío. Las novelas agregadas desde el panel de administración aparecerán aquí automáticamente.
                </p>
              </div>
            )}
              ...
              <div className="bg-white rounded-2xl border-2 border-gray-200 overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 border-b border-gray-200">
                  <div className="flex items-center mb-6">
                    ...
                    <h4 className="text-xl font-bold text-purple-900">Filtros de Búsqueda Avanzada</h4>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    ...
                    <div className="flex space-x-2">
                      <select
                        ...
                        className="flex-1 px-3 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm"
                      >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-3 sm:space-y-0">
                    <div className="text-sm text-purple-700 bg-white/60 px-4 py-2 rounded-xl border border-purple-200">
                      ...
                      {(searchTerm || selectedGenre || selectedYear) && (
                        <span className="ml-2 text-purple-600 font-semibold">• Filtros activos</span>
                      )}
                    </div>
                ...
                <div className="bg-gradient-to-r from-purple-100 to-pink-100 p-6 border-b border-gray-200">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-4 sm:space-y-0">
                    <h4 className="text-xl font-bold text-gray-900">
                      Seleccionar Novelas 
                      <span className="ml-2 bg-purple-200 text-purple-800 px-3 py-1 rounded-full text-sm font-medium">
                        {selectedNovelas.length} seleccionadas
                      </span>
                    </h4>
                    <div className="flex space-x-3">
                      ...
                      <button
                        ...
                        className="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-xl text-sm font-medium transition-colors"
                      >
                        Limpiar Selección
                      </button>
                    </div>
